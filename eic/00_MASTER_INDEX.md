...
| 02 | [Pitch Script (10 min)](./02_PITCH_SCRIPT_10MIN.md) | Timed speaker notes with delivery guidance | ~8 |
...
|--------|--------|----------------|
| Pitch timing | 9:45 - 10:00 | Practice with stopwatch |
| Q&A coverage | Answer 80%+ questions | Study all 53 prepared answers |
| Jury engagement | Eye contact, nodding | Direct address, concrete numbers |
| Technical credibility | Live demo without failure | Test demo 3× before interview |
| Business credibility | Honest about risks | Acknowledge solo founder risk directly |
| EU alignment | Mention sovereignty 3+ times | Weave into solution and impact sections |
