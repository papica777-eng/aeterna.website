...
* **Institut Curie (France)** — Translational Oncology Center of Excellence (WP2/WP3 Co-Lead, Dr. Jean Laurent)
...
* **200-пациентен проспективен клиничен пилот (Shadow Mode):**
  * Провежда се в МУ София, Institut Curie и BSC (60 GBM, 70 PAAD, 70 NSCLC) с 5-точков лонгитюдинален протокол T0–T4.
